...
This file is the quick-reference operating contract for walkdir-kotlin. The longer
...
walkdir-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`walkdir`](https://crates.io/crates/walkdir). Upstream Rust is the behavioral oracle while the
